...
const FAQS = [
  ...
  {
    q: "How is my content generated?",
    a: "Lessons, question sets, and mock exams are generated by durable background jobs — with automatic retries, so a timeout never loses your work. A nightly scheduler pre-generates content for your upcoming study plan, and when something builds in front of you, you see live step-by-step progress instead of a spinner.",
  },
  {
    q: "What does Sage remember about me?",
    a: "Wrong answers, topics you struggle with, session outcomes, and stated preferences (like when you study best) are stored as long-term memories. Sage recalls them in conversation, and future question sets and lessons adapt to your weak spots. Memories stay private to your account.",
  },
  {
